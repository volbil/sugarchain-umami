...
class ConfArgsTest(SugarchainTestFramework):
    ...
    def test_config_file_parser(self):
        ...
        bad_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'sugarchain_bad.conf')
        ...
        main_conf_file_path = os.path.join(self.options.tmpdir, 'node0', 'sugarchain_main.conf')
    ...
    def run_test(self):
        ...
        none_existent_conf_file = os.path.join(default_data_dir, "none_existent_sugarchain.conf")
