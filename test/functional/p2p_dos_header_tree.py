...
class RejectLowDifficultyHeadersTest(SugarchainTestFramework):
    def set_test_params(self):
        ...
        self.chain = (
            "testnet5"  # Use testnet chain because it has an early checkpoint
        )
        self.num_nodes = 2
        self.extra_args = [
    ...
    def add_options(self, parser):
        parser.add_argument(
            "--datafile",
            default="data/blockheader_testnet3.hex",  # Using Sugarchain Testnet (v3), but not Sugarchain Testnet (v5)
