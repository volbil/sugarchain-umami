...
class SimulateTxTest(SugarchainTestFramework):
    ...
    def run_test(self):
        ...
        assert_approx(w0.simulaterawtransaction([tx1])["balance_change"], -(Decimal("5") + sugarchain_fee))
        ...
        #       w1                      0                               +4.9999
        assert_approx(w0.simulaterawtransaction([tx1, tx3])["balance_change"], -Decimal("5") - sugarchain_fee + Decimal("4.9999"))
        assert_approx(w1.simulaterawtransaction([tx1, tx3])["balance_change"], 0)
        assert_approx(w0.simulaterawtransaction([tx1, tx4])["balance_change"], -Decimal("5") - sugarchain_fee)
        ...
        assert_approx(w0.simulaterawtransaction([tx2])["balance_change"], -(Decimal("10") + sugarchain_fee2))
