...
class NetTest(BitcoinTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=34230)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(
            node.addpeeraddress(address="", port=34230), {"success": False}
        )
        ...
        assert_equal(
            node.addpeeraddress(address="1.2.3.4", tried=True, port=34230),
            {"success": True},
        )
        with node.assert_debug_log(
            ...
            assert_equal(addrs[0]["port"], 34230)
        ...
        for value in [True, False]:
            assert_equal(
                node.addpeeraddress(address="1.2.3.4", tried=value, port=34230),
                {"success": False},
            )
        ...
        assert_equal(
            node.addpeeraddress(address="2.0.0.0", port=34230),
            {"success": True},
        )
        with node.assert_debug_log(
