...
def main(sugarchaind_path):
    ...
    # to the tracepoints
    sugarchaind_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    sugarchaind_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    sugarchaind_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    sugarchaind_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
