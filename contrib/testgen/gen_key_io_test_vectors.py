...
bech32_templates = [
    ...
    ("sugar", 2, 2, (False, "main", None, True), Encoding.BECH32M, (OP_2, 2)),
    (
        "tugar",
        0,
        20,
    ...
    ("tugar", 3, 16, (False, "test", None, True), Encoding.BECH32M, (OP_3, 16)),
    (
        "tugar",
        0,
        20,
...
bech32_ng_templates = [
    ...
    ("tsgar", 0, 20, Encoding.BECH32, False, False, False),
    ("tugar", 1, 32, Encoding.BECH32M, False, False, False),
    ("tugar", 17, 32, Encoding.BECH32M, False, False, False),
    ("rugar", 3, 1, Encoding.BECH32M, False, False, False),
    ("sugar", 15, 41, Encoding.BECH32M, False, False, False),
    ("tugar", 0, 16, Encoding.BECH32, False, False, False),
    ("rugar", 0, 32, Encoding.BECH32, True, False, False),
    ("sugar", 0, 16, Encoding.BECH32, True, False, False),
    ("tugar", 0, 32, Encoding.BECH32, False, True, False),
    ("rugar", 0, 20, Encoding.BECH32, False, False, True),
    ("sugar", 0, 20, Encoding.BECH32M, False, False, False),
    ("tugar", 0, 32, Encoding.BECH32M, False, False, False),
    ("rugar", 0, 20, Encoding.BECH32M, False, False, False),
    ("sugar", 1, 32, Encoding.BECH32, False, False, False),
    ("tugar", 2, 16, Encoding.BECH32, False, False, False),
    ("rugar", 16, 20, Encoding.BECH32, False, False, False),
]
