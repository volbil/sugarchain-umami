...
parser = argparse.ArgumentParser(description='Script to get coins from a faucet.', epilog='You may need to start with double-dash (--) when providing sugarchain-cli arguments.')
parser.add_argument('-c', '--cmd', dest='cmd', default='sugarchain-cli', help='sugarchain-cli command to use')
...
parser.add_argument('-a', '--addr', dest='addr', default='', help='Sugarchain address to which the faucet should send')
...
parser.add_argument('sugarchain_cli_args', nargs='*', help='Arguments to pass on to sugarchain-cli (default: -signet)')
