...
- #7209 `f3ad812` test: don't override SUGARCHAIND and SUGARCHAINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add SUGARCHAIND_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
