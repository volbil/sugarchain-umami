...
- Instead of running `make` simply, you should instead run
  `SUGARCHAIN_GENBUILD_NO_GIT=1 make`.
...
- #17910 Remove double `LIBSUGARCHAIN_SERVER` linking (fanquake)
...
- #18429 Remove double `LIBSUGARCHAIN_SERVER` from bench-Makefile (brakmic)
