...
#ifndef SUGARCHAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define SUGARCHAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // SUGARCHAIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
