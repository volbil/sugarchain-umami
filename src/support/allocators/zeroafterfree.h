...
#ifndef SUGARCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define SUGARCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // SUGARCHAIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
